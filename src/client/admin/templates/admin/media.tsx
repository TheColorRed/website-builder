...
export function makeFilter() {
  return tag([
    <div class="fluid row">
      <div class="col media-query-filter">
        <input type="text" placeholder="search" />
        <i class="fas fa-search fa-3x"></i>
      </div>
    </div>,
    {
      tag: <div class="fluid row">
        <a href="" data-type="image" class="col media-filter image-filter">Images</a>
        <a href="" data-type="video" class="col media-filter video-filter">Videos</a>
        <a href="" data-type="audio" class="col media-filter audio-filter">Audio</a>
        <a href="" data-type="font" class="col media-filter compress-filter">Fonts</a>
        <a href="" data-type="application" class="col media-filter other-filter">App</a>
      </div>,
      events: {
        children: {
          click(e) {
...
//                 openDirectory(path)
//                 // $('#media-listings').ajax(FILES_URL, { path }, (data: Listing) => {
//                 //   updateState(path)
//                 //   return Tag.join(
